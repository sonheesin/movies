...
public class NotiReplyController {
	...
	public ResponseEntity<String> create(@RequestBody NotiReplyVO vo) {
		...
		log.info("NotiReplyVO: " + vo);

		int insertCount = service.register(vo);

		log.info("NotiReply INSERT COUNT: " + insertCount);
	...
	/*@GetMapping(value = "/pages/{bno}/{page}",
		...
		public ResponseEntity<List<NotiReplyVO>> getList(
				//댓글 목록 확인 http://localhost/replies/pages/1/1
